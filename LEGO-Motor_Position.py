...
try:
    ...
    while True:
        ...
        print(("Motor D Target Degrees Per Second: %d" % target), "  Motor D Status: ", BP.get_motor_status(BP.PORT_D))
        ...
        try:
            print("Motor B target: %6d  Motor B position: %6d" % (target, BP.get_motor_encoder(BP.PORT_B)),("Motor B Target Degrees Per Second: %d" % target), "  Motor B Status: ", BP.get_motor_status(BP.PORT_B))
